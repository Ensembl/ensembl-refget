...
class Alias(BaseModel):
    alias: str = Field(
        ..., description='Free text alias for a given sequence', json_schema_extra={'example' : 'chr1'}
    )
...
class Metadata1(BaseModel):
    ...
    trunc512: Optional[str] = Field(
        ...
        json_schema_extra={'example' : '959cb1883fc1ca9ae1394ceb475a356ead1ecceff5824ae7'},
    )
